        ...
        case 'add_product':
            ...
            if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
                ...
                if (!in_array($_FILES['image']['type'], $allowed_types)) {
                    $error = "Invalid image type. Allowed types: JPG, PNG, GIF";
            ...
            if (!isset($error)) {
                $stmt = $conn->prepare("INSERT INTO products (user_id, title, description, price, category, image_url) 
                                      VALUES (?, ?, ?, ?, ?, ?)");
    ...
    <div id="addForm" class="add-form" style="display: none;">
        <form action="user-dashboard.php?page=products" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <small class="form-text">Maximum file size: 5MB. Allowed types: JPG, PNG, GIF</small>
            </div>
                ...
                <div class="product-card">
                    ...
                    <div class="product-actions">
                        <form method="POST" class="status-form">
                            ...
                            <select name="status" onchange="this.form.submit()" class="status-select <?php echo $product['status']; ?>">
